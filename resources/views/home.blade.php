        ...
        <div class="col-md-4">
            <div class="card mb-3">
                <div class="row no-gutters">
                    <div class="col-md-4">
                    <img src="img\1_.png" class="card-img" height="350px">
                    </div>
                    <div class="col-md-8">
                    <div class="card-body">
                        <h5 class="card-title"><font color="white">Buat Event</h5>
                        <p class="card-text">Disini kamu bisa buat event sesuai hati kamu</p>
            ...
            <div class="card mb-3">
                <div class="row no-gutters">
                    <div class="col-md-4">
                    <img src="img\3_f.png" class="card-img" height="350px">
                    </div>
                    <div class="col-md-8">
                    <div class="card-body">
                        <h5 class="card-title">My Event</h5>
                        <p class="card-text">Disini kamu bisa melihat event yang sudah kamu buat</p>
            ...
            <div class="card mb-3">
                <div class="row no-gutters">
                    <div class="col-md-4">
                    <img src="img\2_.png" class="card-img" height="350px">
                    </div>
                    <div class="col-md-8">
                    <div class="card-body">
